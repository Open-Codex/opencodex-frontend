    ...
    return (
        <div className="p-6 max-w-6xl mx-auto">
            ...
            <div className="flex gap-4 mb-4">
                <button className={`px-4 py-2 rounded ${tab === 'overview' ? 'bg-purple-600' : 'bg-gray-700'}`} onClick={() => setTab('overview')}>Overview</button>
            ...
            <div className="mt-6">
                ...
                {tab === 'editPermissions' && currentUserId && project &&
                    <EditPermissions
